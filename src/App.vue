  ...
  <div id="app" class="min-h-screen bg-gray-200 antialiased">
    ...
    <main class="py-6">
      ...
      <div class="px-4">
        ...
        <p class="text-gray-600">live like the stars in these luxuries Southern California estates</p>
      </div>
          ...
          <div v-for="i in 4" :key="i" :class="{'mt-10' : i > 1}" class="sm:mt-0 sm:max-w-xs sm:w-full sm:flex-shrink-0 sm:px-2">
            ...
            <div class="relative h-64 pb-5/6">
              <img class="absolute inset-0 h-full w-full rounded-lg shadow-md object-cover"
                src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80">
            </div>
            ...
            <div class="relative px-4 -mt-16">
              <div class="bg-white rounded-lg px-4 py-4 shadow-lg">
                ...
                <div class="mt-2 flex items-center text-sm text-gray-600">
                  <svg class="h-4 w-4 fill-current text-teal-500" height="511pt" viewBox="0 -10 511.99143 511"
